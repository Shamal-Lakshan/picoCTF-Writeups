...
There’s nothing in the web 

But,

in the inspector(ctrl+shift+I) —> Sources, We can find a folder called “wasm”

by viewing the wasm contents we find a assembly file called a784ba16
...
in the last part of the code (line 0x0338) we can find a string inside double quotes. by submitting the flag to the input field in the HTML we can get a message saying correct.
